#!/usr/bin/python3
"""The script uunittests for models/user.py.
...
class TestUser_instantiation(unittest.TestCase):
    """The script Unittests for testing instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """This unittests for testing save method of the  class."""
