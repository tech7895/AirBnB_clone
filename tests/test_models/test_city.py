#!/usr/bin/python3
"""The script defines unittests for models/city.py
...
class TestCity_instantiation(unittest.TestCase):
    """The script nittests for testing instantiation of the City class"""
    ...
    def test_str_representation(self):
        ...
        self.assertIn("'created_at': " + cdt_repr, cystr)
        self.assertIn("'updated_at': " + cdt_repr, cystr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        self.assertEqual(cy.created_at, cdt)
        self.assertEqual(cy.updated_at, cdt)
...
class TestCity_save(unittest.TestCase):
    """The script unittests for testing save method of the City class"""
...
class TestCity_to_dict(unittest.TestCase):
    """The script unittests for testing to_dict method of
    the City class."""
